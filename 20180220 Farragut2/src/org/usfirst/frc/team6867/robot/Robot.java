...
public class Robot extends IterativeRobot {
	...
	public void teleopPeriodic() {
		...
		if (controller.getRawAxis(3) >= 0.05) {
			frontleftdrive.set((controller.getRawAxis(3) + controller.getRawAxis(4)) * speedMaster);
			rearleftdrive.set((controller.getRawAxis(3) + controller.getRawAxis(4)) * speedMaster);
			frontrightdrive.set(-(controller.getRawAxis(3) - controller.getRawAxis(4)) * speedMaster);
			rearrightdrive.set(-(controller.getRawAxis(3) - controller.getRawAxis(4)) * speedMaster);
		} else if (controller.getRawAxis(2) >= 0.05)

		{
			frontleftdrive.set(-(controller.getRawAxis(2) + controller.getRawAxis(4)) * speedMaster);
			rearleftdrive.set(-(controller.getRawAxis(2) + controller.getRawAxis(4)) * speedMaster);
