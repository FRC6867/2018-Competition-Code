...
//		 if (controller.getRawAxis(1) <= -0.05) {
//			 frontLeft.set(controller.getRawAxis(1) * speed);
//			 backLeft.set(controller.getRawAxis(1) * speed); 
//		 } else if(controller.getRawAxis(1) >= 0.05) { 
//			 frontLeft.set(-controller.getRawAxis(1) * speed); 
//			 backLeft.set(-controller.getRawAxis(1) * speed); 
//		} else {
//		 frontLeft.set(0); 
...
//		} 
//		 
//		 if (controller.getRawAxis(5) <= -0.05) {
//		 	frontRight.set(-controller.getRawAxis(5) * speed);
//		 	backRight.set(-controller.getRawAxis(5) * speed); 
//		 } else if (controller.getRawAxis(5) >= 0.05) { 
//			 frontRight.set(controller.getRawAxis(5) * speed); 
//			 backRight.set(controller.getRawAxis(5) * speed); 
//		 } else {
//			 frontRight.set(0); 
